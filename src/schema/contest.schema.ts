...
export const updateContestApiSchema = z
  .object({
    title: z
      .string()
      .trim()
    ...
    start_date: contestDateSchema,

    end_date: contestDateSchema,
...
export type UpdateContestApiPayload = z.infer<typeof updateContestApiSchema>;