...
const Hero = () => {
  ...
  "
      ...
      <div className="absolute bg-black/20 top-0 right-0 opacity-10 -z-5 h-full w-full rotate-180">
        <Image
      ...
      <div className="absolute bg-black/20 top-0 right-0 lg:opacity-1 opacity-2 -z-5 h-full w-full rotate-180">
        <Image
          src={'/svg/wwwhirl.svg'}
          className="pointer-events-none h-full w-full object-cover select-none"
          alt=""
