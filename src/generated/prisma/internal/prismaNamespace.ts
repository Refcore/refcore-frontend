...
export const ChannelsScalarFieldEnum = {
  ...
  whatsapp_verified_at: 'whatsapp_verified_at',
  status: 'status',
  channel_members_limit: 'channel_members_limit',
  created_at: 'created_at',
  updated_at: 'updated_at',
...
export const ContestsScalarFieldEnum = {
  ...
  top_performer_phone: 'top_performer_phone',
  top_performer_referrals: 'top_performer_referrals',
